...
class UsuarioCollector extends Collector
{
  ...
  function createUsuario($email, $contrasena) {   
    echo "$email, $contrasena"; 
    $insertrow = self::$db->insertRow("INSERT INTO clubNutricion.usuario (idusuario, email, contrasena)
                                      VALUES (?, ?, ?)", array(null, "{$email}", "{$contrasena}"));
  }  
